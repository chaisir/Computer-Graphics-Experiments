...
public class main extends JPanel {
    ...
    static int a[]=new int [20];        //直线点的x坐标
    static int b[]=new int [20];        //直线点的y坐标
    ...
    public void paintComponent(Graphics g) {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if(e.getButton() == e.BUTTON1) {
                    ...
                    if(add && index<2) {
                        ...
                        System.out.println("直线第"+index+"个点坐标为("+a[index]+","+b[index]+")");
                        index++;
        ...
        if(time!=0) {                           //裁剪直线
            ...
            clipping_single_line(a[0],b[0],a[1],b[1],g2d);
